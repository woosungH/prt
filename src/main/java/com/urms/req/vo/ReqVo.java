...
//fields
	...
	private String result_reg_dttm; //실적등록일(처리완료)
	private String clear_con; //처리내용
	private String org_code; //소속
...
public ReqVo(String req_id, String sys_info_nm, String req_no, String req_type, String req_title, String req_con,
		...
		String reg_dttm, String mod_dttm, String clear_st_dttm, String clear_due_dttm, String result_reg_dttm,
		String clear_con, String org_code) {
	super();
	this.req_id = req_id;
...
public String toString() {
	return "ReqVo [req_id=" + req_id + ", sys_info_nm=" + sys_info_nm + ", req_no=" + req_no + ", req_type=" + req_type
			+ ", req_title=" + req_title + ", req_con=" + req_con + ", req_file=" + req_file + ", req_nm=" + req_nm
			+ ", reg_nm=" + reg_nm + ", mod_nm=" + mod_nm + ", req_end_dttm=" + req_end_dttm + ", req_dttm=" + req_dttm
			+ ", reg_dttm=" + reg_dttm + ", mod_dttm=" + mod_dttm + ", clear_st_dttm=" + clear_st_dttm
			+ ", clear_due_dttm=" + clear_due_dttm + ", result_reg_dttm=" + result_reg_dttm + ", clear_con=" + clear_con
			+ ", org_code=" + org_code + "]";
}
}
